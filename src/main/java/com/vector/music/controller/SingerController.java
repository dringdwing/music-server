...
import com.vector.music.domain.Singer;
...
public class SingerController {
    ...
    public Object deleteSinger(HttpServletRequest request){
        ...
        String singerPicUrl = singerService.selectByPrimaryKeySong(Integer.parseInt(id));
        String pathName = System.getProperty("user.dir") + System.getProperty("file.separator");
        //实际的文件地址
        File file = new File(pathName + singerPicUrl);
        System.out.println("*实际的文件地址*************"+file);
