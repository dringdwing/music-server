...
import com.vector.music.domain.Comment;
import com.vector.music.domain.Give;
import com.vector.music.service.CommentService;
...
//        //保存到点赞的对象中
//        Give give = new Give();
//        give.setConsumerId(Integer.parseInt(id));
//        give.setConsumerId(Integer.parseInt(userId));
//        give.setSongListId(Integer.parseInt(songListId));
//        //插入记录
//        boolean insert = giveService.insert(give);
//        System.out.println("****是否插入成功******" + insert);
//
//        int i = giveService.selectGiveType(Integer.parseInt(songListId), Integer.parseInt(userId));
//        System.out.println("****是否插入成功查询******" + i);
//        if (0 == i) {
//            //保存到评论的对象中
//            Comment comment = new Comment();
//            comment.setId(Integer.parseInt(id));
...
//
//                //把点赞状态设置为已点
//                boolean update = giveService.update(give);
//                System.out.println("是否成功update******" + update);
//
//                jsonObject.put(Consts.CODE, 1);
//                jsonObject.put(Consts.MSG, "点赞成功");
//                return jsonObject;
...
//        }
//        jsonObject.put(Consts.CODE, 0);
//        jsonObject.put(Consts.MSG, "禁止重复点赞");
//        return jsonObject;
